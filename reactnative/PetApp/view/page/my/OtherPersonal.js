...
export default class OtherPersonal extends Component {
    constructor(props) {
        super(props);
        this.state = {
            login_id: '',
    ...
    componentWillMount() {
        ...
        let login_id = this.props.navigation.state.params.login_id;
        this.setState({
            loading: true,
            user_id: user_id,
            login_id: login_id,
        ...
        this.start(user_id);
        this.isAttentions(login_id, user_id);
    ...
    isAttentions = (login_id, user_id) => {
        /*
         *  判断该用户是否已经被关注
         */
        let param = {'login_id': login_id, 'user_id': user_id};
        Model.isAttention(param, (json) => {
            // console.log("isAttentionjson", json)
            this.setState({
                isAttention:json.code
            })
        }, (json) => {
        ...
        return (
            <View style={[Style.barTop]}>
                ...
                <View style={[Style.barView, Style.flexRowBetween]}>
                    ...
                    >
                        <View>
                            <Text style={[Style.barText, Style.font_1]}>他的主页</Text>
                        </View>
                    </TouchableHighlight>
                    <TouchableHighlight
                        underlayColor={'transparent'}
            ...
            <View style={[styles.text_1, Style.backgroundColor_1, Style.flexRowCenter, Style.shadow_1]}>
                <View style={[styles.headView, Style.flexColumnAround]}>
                    <View style={[Style.flexRowCenter]}>
                        ...
                        {
                            this.state.isAttention != 200 ?
                                <TouchableHighlight underlayColor={'transparent'}
                                                    onPress={() => this.attentions(this.state.user_id)}>
    ...
    _listArticle = (data) => {
        ...
        return (
            <TouchableHighlight underlayColor={'transparent'}
                                onPress={() => this.jump('ArticleDetailsOld', {data: data})}>
    ...
    _listDynamic = (data) => {
        ...
        return (
            <TouchableHighlight underlayColor={'transparent'}
                                onPress={() => this.jump("DynamicDetails", {data: data})}>
                <View style={[styles.child_text, Style.shadow_2, Style.flexColumnStart]}>
                    <View style={[styles.article_contains]}>
                        <Text
    ...
    _listVideo = (data) => {
        ...
        return (
            <TouchableHighlight underlayColor={'transparent'}
                                onPress={() => this.jump('VideoDetails', {data: data})}>
                <View style={[styles.child_text, Style.shadow_2, Style.flexColumnStart]}>
                    <View style={[styles.article_title]}>
                        <Text style={[styles.article_title_font]}>{data.title}</Text>
                    </View>
