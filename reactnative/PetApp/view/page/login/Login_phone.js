...
export default class Login_phone extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = {
            residue_time_show: Global.getTime.phone_show,
            iphone: '',
            modifyCode: '',
            uid:'', //用来存放验证码对用数据库的编号
        }
    ...
    componentWillMount() {
        this.timer_phone && clearInterval(this.timer_phone)
    }
    ...
    calumniateTime = ()=> {
         ...
         *  计时器处理
         */
        Global.getTime.phone_show = !Global.getTime.phone_show;
        if (Global.getTime.phone_show) {
            this.timer_phone = setInterval(()=> {
                Global.getTime.phone_time -= 1;
                if (Global.getTime.phone_time == 0) {
                    clearInterval(this.timer_phone);
                    Global.getTime.phone_time = 59;
                }
            }, 1000);
        }
        this.setState({
        ...
        return (
            <View style={[Style.barTop]}>
                ...
                <View style={[Style.barView, Style.flexRowBetween]}>
                    ...
                    >
                        <View>
                            <Text style={[Style.barText, Style.font_1]}>手机登录</Text>
                        </View>
                    </TouchableHighlight>
                    <TouchableHighlight
                        underlayColor={'transparent'}
    ...
    _list = ()=> {
         ...
         */
        return (
            <View style={[Style.flexColumnStart, Style.contains, Style.backgroundColor_1]}>
